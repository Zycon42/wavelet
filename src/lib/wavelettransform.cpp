...
void WaveletTransform::forward1d(VectorXf& signal) {
	...
	for (int i = 0; i < numLevels; ++i) {
		wavelet->forward(ArrayRef<float>(signal.data(), size));
		size /= 2;
	}
}

void WaveletTransform::inverse1d(VectorXf& dwt) {
